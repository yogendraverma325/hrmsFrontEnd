...
import { Button, Card, CardActions, CardContent, CardHeader, Chip, ClickAwayListener, Grid, ListItemAvatar, Paper, Popper, Stack, TextField, useMediaQuery } from '@mui/material';
            ...
            <AppBar position="fixed" open={Utils.isActive} sx={{ backgroundColor: '#104155' }}>
                <Toolbar>
                    ...
                    <Box sx={{ flexGrow: 0 }}>
                        ...
                        >
                            {({ TransitionProps }) => (
                                <Transitions position={matchesXs ? 'top' : 'top-right'} in={notificationOn} {...TransitionProps}>
                                    <Paper>
                                        <ClickAwayListener onClickAway={handleCloseNotificationMenu}>
                                            ...
                                            <MainCard border={false} elevation={16} content={false} boxShadow>
                                                <Grid container direction="column" spacing={2}>
                                                    ...
                                                    <Grid item xs={12}>
                                                        <PerfectScrollbar style={{ height: 'auto', maxHeight: 'calc(100vh - 150px)', overflowX: 'hidden' }}>
                                                            <NotificationList />
                                                        </PerfectScrollbar>
                                                    </Grid>
                                                </Grid>
                        ...
                        >
                            {({ TransitionProps }) => (
                                <Transitions position={matchesXs ? 'top' : 'top-right'} in={userMenuOn} {...TransitionProps}>
                                    <Paper>
