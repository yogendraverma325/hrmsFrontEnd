...
function Dashboard() {
  ...
  return (
    <>
      If you need to wrap the MUI components with MUI's own container components, you can
      use Grid and Paper components from Material-UI to achieve this. Here's how you can
      do it: jsx import from '@mui/material';
      <Grid item xs={12} md={12} lg={4} className="css-1px0r2z">
        <Paper elevation={0} className="css-2yksad">
          <div className="css-18mhetb">
            <Typography variant="body2" className="css-q5s9g4">
              <svg
                className="css-6flbmm"
                focusable="false"
                aria-hidden="true"
                viewBox="0 0 24 24"
            ...
            <Grid container spacing={1} className="css-tuxzvu">
              <Grid item xs={12} className="css-15j76c0">
                <Typography variant="h5" className="css-1tih3eg">
                  Revenue
                </Typography>
              </Grid>
              <Grid item xs={12} className="css-15j76c0">
                <Typography variant="h3" className="css-1m3k1kp">
                  $42,562
                </Typography>
              </Grid>
              <Grid item xs={12} className="css-15j76c0">
                <Typography variant="subtitle2" className="css-1gm1qc1">
                  $50,032 Last Month
                </Typography>
              </Grid>
            </Grid>
