...
import { FormControl, FormControlProps, FormHelperText, FormLabel, InputLabel, OutlinedInput, OutlinedInputProps, TextField } from "@mui/material";
...
const InputField: FC<InputFieldProps> = ({ label, sx, helperText, size = "medium", ...inputProps }) => {
  ...
  error={Boolean(meta.touched && meta.error)}
   ...
   value={field.value ?? ""}
    ...
    size="small"
    />
  {!meta.error && helperText && <FormHelperText id={`helper-text-${field.name}`}>{helperText}</FormHelperText>}
